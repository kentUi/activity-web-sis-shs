                ...
                <div class="card">
                    <div class="card-inner-group">
                        <div class="card-inner">
                            ...
                            <?php endif; ?>
                            <form action="<?php echo e(route('strand.register')); ?>" method="POST" autocomplete="off">
                                <?php echo csrf_field(); ?>
                                <div class="row gy-4">
                                    <div class="col-md-3">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DEV.KENT\Documents\Software Development\_FlexifyDigitalServer64\www\caps_shs_sis_laravel_html\activity-web-sis-shs\resources\views/pages/strands/registration.blade.php ENDPATH**/ ?>