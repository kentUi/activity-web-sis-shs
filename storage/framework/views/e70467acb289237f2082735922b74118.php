                ...
                <div class="row g-gs">
                        ...
                        <div class="card is-dark h-100">
                            <div class="nk-ecwg nk-ecwg1">
                                <div class="card-inner">
                                    ...
                                    ?>
                                    <div class="data">
                                        <div class="amount"><?php echo e($student); ?></div>
                                    </div>
                                    <div class="data">
                                        <h6 class="sub-title">Teachers</h6>
                                        <div class="data-group">
                                            <div class="amount"><?php echo e($teacher); ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div><!-- .nk-ecwg -->
                    ...
                    <div class="col-sm-5">
                        <div class="card h-100">
                            <div class="card-inner pb-1" style="min-height: 50px">
                                <center>
                                    <img src="/<?php echo e($schools->sc_logo); ?>" alt="" height="130">
                                    <hr>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DEV.KENT\Documents\Software Development\_FlexifyDigitalServer64\www\caps_shs_sis_laravel_html\activity-web-sis-shs\resources\views/pages/ict/dashboard.blade.php ENDPATH**/ ?>