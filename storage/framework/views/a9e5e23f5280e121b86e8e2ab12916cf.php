                ...
                <div class="row g-gs">
                    ...
                    <div class="col-sm-12 col-lg-12 col-xxl-4">
                        <div class="card h-100">
                            ...
                            <div class="p-4">
                                <form action="<?php echo e(route('test.import')); ?>" method="post" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kent/Development/SIS-SENIORHIGHSCHOOL/resources/views/pages/sections/import.blade.php ENDPATH**/ ?>