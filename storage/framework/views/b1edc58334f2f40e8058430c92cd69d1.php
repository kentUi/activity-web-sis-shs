                        ...
                        <a href="#" class="dropdown-toggle me-n1" data-bs-toggle="dropdown">
                            <div class="user-toggle">
                                ...
                                <div class="user-info d-none d-xl-block">
                                    <div class="user-status user-status-active" style="text-transform: uppercase">ROLE: <?php echo e($user['type']); ?></div>
                                    <div class="user-name dropdown-indicator" style="text-transform: uppercase"><?php echo e($user['name']); ?></div>
                                </div>
                            </div>
                        </a>
...
</div><?php /**PATH /home/kent/Development/SIS-SENIORHIGHSCHOOL/resources/views/theme/header-top.blade.php ENDPATH**/ ?>