                            ...
                            <ul class="nk-block-tools g-3">
                                <li>
                                    <div class="form-control-wrap">
                                        ...
                                        <input type="text" onkeypress="handleKeyPress(event)" class="form-control" id="default-04" placeholder="Search by name">
                                    </div>
                                </li>
                                <li class="nk-block-tools-opt">
                                    <a class="btn btn-icon btn-info d-md-none" href="/students/register"><em class="icon ni ni-plus"></em></a>
                                    <a class="btn btn-info d-none d-md-inline-flex" href="/students/register"><em class="icon ni ni-plus"></em><span>Register Student</span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="card-inner p-0">
                        <div class="nk-tb-list nk-tb-ulist">
                            <div class="nk-tb-item nk-tb-head">
                                ...
                                <div class="nk-tb-col tb-col-lg text-right"><span class="sub-text">Mobile No.</span></div>
                                    ...
                                    <a href="#">
                                        <div class="user-card">
                                            ...
                                            <div class="user-info" style="text-transform: uppercase">
                                                ...
                                                <span><?php echo e($rw->student_lrd); ?></span>
                                            </div>
                                        </div>
                                    </a>
                                </div>
                                <div class="nk-tb-col tb-col-md text-right">
                                    <b><span class="text-dark"><?php echo e($rw->student_gender); ?></span></b>
                                </div>
                                <div class="nk-tb-col tb-col-lg text-right">
                                    <b><span class="text-dark"><?php echo e($rw->student_mobile); ?></span></b>
                                </div>
                                <div class="nk-tb-col tb-col-lg text-right">
                                ...
                                function handleKeyPress(event) {
                                    if (event.keyCode === 13) {
                                        if (event.target.value === "") {
                                            ...
                                            window.location.href = '/students/search/' + event.target.value;
                                        }
                                    }
                                }
                            </script>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kent/Development/SIS-SENIORHIGHSCHOOL/resources/views/pages/students/list.blade.php ENDPATH**/ ?>