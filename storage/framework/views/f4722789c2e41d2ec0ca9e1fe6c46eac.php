...
<div class="" style="font-family: Arial, Helvetica, sans-serif; font-size: 12px;">
    <div id="form137">
        <div id="PrintGradeReportFrontPage">
            <table style="width:100%; border-collapse: collapse;" border="0">
                <tr>
                    <td style="text-align: center; width: 25%;">
                        <img src="<?php echo e(asset('deped seal.webp')); ?>" height="100" />
                    </td>
                    <td style="text-align: center; width: 50%;">
                        <span>Republic of the Philippines</span><br />
                        <span>Department of Education</span><br />
                        <span style="font-size: 18px; font-weight: bold;">Learner Permanent Record for Junior High School (SF10-JHS)</span><br />
                        <span>(Formerly form 137)</span>
                    </td>
                    <td style="text-align: center; width: 25%;">
                        <img src="<?php echo e(asset('/logo.png')); ?>" height="100"/>
                    </td>
                </tr>
            </table>
            <table style="width:100%; border-collapse: collapse; font-weight: bold; margin-top: 15px;" border="0">
                <tr>
                ...
                <tr>
                    ...
                    <td style="width: 15%; text-transform: uppercase; text-align: center; border-bottom: 1px solid black;"></td>
                    <td style="width: 15%; text-transform: capitalize; padding-left: 20px;">first name</td>
                    <td style="width: 15%; text-transform: uppercase; text-align: center; border-bottom: 1px solid black;"></td>
                    <td style="width: 15%; text-transform: capitalize; text-align: right;">name ext. (jr,ii,iii)</td>
                    <td style="width: 15%; text-transform: uppercase; text-align: center; border-bottom: 1px solid black;"></td>
                    <td style="width: 15%; text-transform: capitalize; padding-left: 20px;">middle name</td>
                    <td style="width: 15%; text-transform: uppercase; text-align: center; border-bottom: 1px solid black;"</td>
                </tr>
                <tr>
                    <td colspan="2" style="width: 15%; text-transform: capitalize;">learner reference number (lrn)</td>
                    <td style="width: 15%; text-transform: uppercase; text-align: center; border-bottom: 1px solid black;"></td>
                    <td colspan="2" style="width: 15%; text-transform: capitalize; text-align: right; padding-right: 20px;">birthdate</td>
                    <td style="width: 15%; text-transform: uppercase; text-align: center; border-bottom: 1px solid black;"></td>
                    <td style="width: 15%; text-transform: capitalize; text-align: right; padding-right: 20px;">sex</td>
                    <td style="width: 15%; text-transform: uppercase; text-align: center; border-bottom: 1px solid black;"></td>
                </tr>
            </table>
            <br />
            ...
            <table style="border: 0px solid black; width: 100%; border-collapse: collapse; font-weight: bold;" border="0">
                <tr>
            ...
            <table style="width: 100%; border-collapse: collapse;" border="0">
                <tr>
                    ...
                    <td style="text-transform: uppercase; font-weight: bold; border-bottom: 1px solid black;">Generic National High School</td>
                    <td style="text-transform: capitalize;">school ID</td>
                    <td style="text-transform: uppercase; font-weight: bold; border-bottom: 1px solid black;">315402</td>
                    <td style="text-transform: capitalize;">district</td>
                    <td style="text-transform: uppercase; font-weight: bold; border-bottom: 1px solid black;">East II</td>
                    <td style="text-transform: capitalize;">division</td>
                    <td style="text-transform: uppercase; font-weight: bold; border-bottom: 1px solid black;">Division of Cagayan de Oro City</td>
                    <td style="text-transform: capitalize;">region</td>
                    <td style="text-transform: uppercase; font-weight: bold; border-bottom: 1px solid black;">Region X</td>
                </tr>
            </table>
            <table style="width: 100%; border-collapse: collapse;" border="0">
                <tr>
                    <td style="text-transform: capitalize;">classified grade</td>
                    <td style="width: 8%; text-transform: uppercase; font-weight: bold; border-bottom: 1px solid black;"></td>
                    ...
                    <td style="width: 15%; text-transform: uppercase; font-weight: bold; border-bottom: 1px solid black;"></td>
                </tr>
            </table>
            <table style="border: 1px solid #171717; border-collapse: collapse; margin-top: 10px;">
                <tr>
                    <td style="border: 1px solid; font-weight: bold; text-align: center;" rowspan="2">Learning Area</td>
                    <td style="border: 1px solid; font-weight: bold; text-align: center;" colspan="4">Quarter</td>
                    <td style="border: 1px solid; font-weight: bold; text-align: center;" rowspan="2">Final Grade</td>
                    <td style="border: 1px solid; font-weight: bold; text-align: center;" rowspan="2">Remarks</td>
                </tr>
                <tr>
            ...
            <table style="border: 1px solid black; width: 100%; border-collapse: collapse; font-weight: bold; margin-top: 15px;" border="1">
                <tr>
            ...
            <table style="width: 100%; border-collapse: collapse;" border="0">
                <tr>
                    <td colspan="8" style="border: 2px solid black; text-align: center;">
                        I Certify that this is a true record of <u style="font-weight: bold;"></u> with LRN <u style="font-weight: bold;"></u> and that he/she is eligible for admission for Grade <u style="font-weight: bold;"></u> Name of School <u style="font-weight: bold;">Generic National High School</u> School ID <u style="font-weight: bold;">315402</u> last school year attended: <u style="font-weight: bold;"></u>
                    </td>
                </tr>
            </table>
        </div>
...
</html><?php /**PATH C:\Users\DEV.KENT\Documents\Software Development\School Management System\DepEd Senior High School\resources\views/layout/form137.blade.php ENDPATH**/ ?>