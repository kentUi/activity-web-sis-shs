                        ...
                        <div class="card-inner">
                            <?php if(isset($_GET['s'])): ?>
                                ...
                                <div class="alert alert-success" style="width: 100%;">
                                    <b><em class="icon ni ni-check"></em> <?php echo e($subject->subj_title); ?></b> has been assigned
                                    to <b><?php echo e($teacher->tech_lname); ?>, <?php echo e($teacher->tech_fname); ?></b> in section
                                    <b><?php echo e($section->sec_name); ?></b>
                                </div>
                                <hr>
                            <?php endif; ?>
                                                        ...
                                                        <div class="drodown" style="">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                <ul class="link-list-opt no-bdr">
                                                                    <li>
                                                                        <a href="#"
                                                                            onclick="assign(<?php echo e($rw->sec_id); ?>, <?php echo e($rw->subj_id); ?>, <?php echo e($user['schoolid']); ?>)"
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DEV.KENT\Documents\Software Development\_FlexifyDigitalServer64\www\caps_shs_sis_laravel_html\activity-web-sis-shs\resources\views/pages/subjects/assigned.blade.php ENDPATH**/ ?>