        ...
        <div class="nk-content-body">
            <div class="nk-block-head nk-block-head-sm">
                <div class="nk-block-between">
                    ...
                    <div class="nk-block-head-content">
                        <a href="<?php echo e(asset('source/template.xlsx')); ?>" download class="btn btn-primary"><em
                                        ...
                                        <tbody>
                                            ...
                                            <?php for($i = 6; $i <= count($list); $i++): ?>
                                                <tr>
                                                    <td><?php echo e($i); ?>.</td>
                                                    <td>
                                                        <?php echo e($list[$i]['student_lname']); ?>, <?php echo e($list[$i]['student_fname']); ?>

                                                        <?php echo e($list[$i]['student_mname']); ?> <?php echo e($list[$i]['student_extname']); ?>.
                                                    </td>
                                                    <td><?php echo e($list[$i]['student_gender']); ?></td>
                                                    <td><?php echo e($list[$i]['student_mobile']); ?></td>
                                                    <td><?php echo e($list[$i]['student_email']); ?></td>
                                                    <td >
                                                        <?php if($list[$i]['status'] == 'Saved'): ?>
                                                            <b class="text-success"><em class="ni ni-user-check"></em>
                                                                <?php echo e($list[$i]['status']); ?></b>
                                                        <?php else: ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DEV.KENT\Documents\Software Development\_FlexifyDigitalServer64\www\caps_shs_sis_laravel_html\activity-web-sis-shs\resources\views/pages/sections/import.blade.php ENDPATH**/ ?>