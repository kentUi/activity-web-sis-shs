@php
    ...
    $user = session('info');
@endphp
<b style="float: left;">Page 2</b>
<b style="float: right;">SF10-SHS</b>

<table
    style="width: 100%; border-collapse: collapse; font-weight: bold; margin: 0; padding-top: 0; border-top: 1px solid #000">
    <tr>
...
<table style="border-collapse: collapse; margin: 0px; padding: 0;">
    ...
    @foreach ($response_1 as $rw_1)
        ...
        @endphp
        <tr>
            <td style="border: 1px solid; font-weight: bold; text-align: center; padding-top: 0">{{ $rw_1->subj_type }}
            </td>
