                            ...
                            <div class="card-aside-wrap">
                                <div class="card-inner card-inner-lg">
                                    @if (isset($_GET['advisory']))
                                        @include('pages.teachers.details.advisory', [
                                            'advisory' => $advisory,
                                        ])
                                    @elseif (isset($_GET['assigned']))
                                        @include('pages.teachers.details.subjects', [
                                            'advisory' => $assign_subject,
                                        ])
                                    @elseif (isset($_GET['settings']))
                                        @include('pages.teachers.details.settings', [
                                            'advisory' => $assign_subject,
                                        ])
                                    @else
                                            ...
                                            <div class="nk-data data-list">
                                                ...
                                                <div class="data-item">
                                                    <div class="data-col">
                                                        ...
                                                        <span class="data-value">
                                                            {{ $personal_info->tech_lname }},
                                                            {{ $personal_info->tech_fname }}
                                                            {{ $personal_info->tech_mnme }}
                                                            {{ $personal_info->tech_extname }}
                                                        </span>
                                                    </div>
                                                ...
                                                <div class="data-item">
                                                    <div class="data-col">
                                                        ...
                                                        <span class="data-value">{{ $personal_info->tech_gender }}</span>
                                                    </div>
                                                    <div class="data-col data-col-end"></div>
                                                </div>
                                                <div class="data-item">
                                                    <div class="data-col">
                                                        ...
                                                        <span
                                                            class="data-value">{{ $personal_info->tech_civilStatus }}</span>
                                                    </div>
                                                    <div class="data-col data-col-end"></div>
                                                </div>
                                                <div class="data-item">
                                                    <div class="data-col">
                                                        ...
                                                        <span class="data-value">{{ $personal_info->tech_email }}</span>
                                                    </div>
                                                ...
                                                <div class="data-item">
                                                    <div class="data-col">
                                                        ...
                                                        <span class="data-value">{{ $personal_info->tech_phone }}</span>
                                                    </div>
                                                    <div class="data-col data-col-end"></div>
                                                </div>
                                                <div class="data-item">
                                                    <div class="data-col">
                                                        ...
                                                        <span
                                                            class="data-value">{{ date_format(date_create($personal_info->tech_birthdate), 'M. d, Y') }}</span>
                                                    </div>
                                                    <div class="data-col data-col-end"></div>
                                                </div>
                                                <div class="data-item" data-tab-target="#address">
                                                    <div class="data-col">
                                                        ...
                                                        <span class="data-value">{{ $personal_info->tech_address }}</span>
                                                    </div>
                                                    <div class="data-col data-col-end"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="user-card">
                                                ...
                                                <div class="user-info" style="text-transform: uppercase;">
                                                    <span class="lead-text">
                                                        {{ $personal_info->tech_lname }}, {{ $personal_info->tech_fname }}
                                                        {{ $personal_info->tech_mnme }} {{ $personal_info->tech_extname }}
                                                    </span>
                                                    <span class="sub-text">{{ $personal_info->tech_email }}</span>
                                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body modal-body-xl">
                    ...
                    <div class="row gy-4 mt-1">
                        <form action="{{ route('teacher.update') }}" method="POST" autocomplete="off">
                            @csrf
                            <div class="row gy-4">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input name="inp_fname" type="text" class="form-control" id="full-name"
                                            value="{{ $personal_info->tech_fname }}" placeholder="Enter First name">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input name="inp_lname" type="text" class="form-control" id="display-name"
                                            value="{{ $personal_info->tech_lname }}" placeholder="Enter Last name">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="form-label" for="display-name">Middle Name</label>
                                        <input name="inp_mname" type="text" value="{{ $personal_info->tech_mname }}"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input name="inp_extname" type="text" class="form-control" id="display-name"
                                            value="{{ $personal_info->tech_extname }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <select name="inp_gender" class="form-select js-select2"
                                                ...
                                                <option value="{{ $personal_info->tech_gender }}" selected>
                                                    {{ $personal_info->tech_gender }}</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <select name="inp_civil" class="form-select js-select2"
                                                data-placeholder="Select multiple options">
                                                <option value="{{ $personal_info->tech_civilStatus }}" selected>
                                                    {{ $personal_info->tech_civilStatus }}</option>
                                                <option disabled>----</option>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input name="inp_birth" type="text" class="form-control date-picker"
                                            id="birth-day"
                                            value="{{ date_format(date_create($personal_info->tech_birthdate), 'm/d/Y') }}"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input name="inp_mobile" value="{{ $personal_info->tech_phone }}" type="text"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="Y7cbdb3e4ebb" value="{{ $personal_info->tech_id }}">
                                        <input name="inp_address" type="text"
                                            value="{{ $personal_info->tech_address }}" class="form-control"
                                ...
                                <div class="col-md-12">
                                    <ul class="align-center flex-wrap flex-sm-nowrap gx-4 gy-2">
                                        ...
                                        <li>
                                            <button type="button"
                                                onclick="confirmation({{ $personal_info->tech_id }}, 'teacher')"
