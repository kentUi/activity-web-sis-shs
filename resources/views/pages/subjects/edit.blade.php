                                                ...
                                                <div class="g w-100">
                                                    <div class="form-control-wrap">
                                                        <select <?= $edit ?> name="inp_gradelevel" required id="" class="form-control">
                                                            <option value="{{$info->subj_gradelevel}}">Grade {{$info->subj_gradelevel}}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <input <?= $edit ?> type="text" required name="inp_course" class="form-control" id="full-name"
                                            placeholder="e.g. Mathematics" value="{{ $info->subj_title }}">
                                ...
                                <div class="col-md-12">
                                    <ul class="align-center flex-wrap flex-sm-nowrap gx-4 gy-2">
                                        ...
                                        @if (isset($_GET['edit']))
                                            ...
                                            <li>
                                                <button type="button"
                                                    onclick="confirmation({{ $info->subj_id }}, 'subject')" name="delete"
